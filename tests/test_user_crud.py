...
class TestUserCrud(unittest.TestCase):
    def setUp(self):
        ...
        with self.app.app_context():  # associate the app with the current context
            ...
            self.test_user = {"first_name": "Onen", "last_name": "Julius",
    ...
    def test_user_is_created(self):
        ...
        self.assertDictEqual(
            res, {"status": "success", "message": "User registered successfully"}, "User registration failed")
    ...
    def test_duplicate_user_is_created(self):
        ...
        duplicate = self.client.post(
            "api/v1/auth/register", data=self.test_user)
    ...
    def test_user_logs_out(self):
        ...
        self.assertDictEqual(json.loads(logout.data), {
    ...
    def test_user_reset_password(self):
        ...
        reset_password = self.client.post(
            "api/v1/auth/password_reset", data=reset_data, headers={"Authorization": auth})
        self.assertEqual(reset_password.status_code,
                         201, "Passsword was not reset")
        new_login_data = {"email": "jonen54@gmail.com",
                          "password": "257thjuly"}
        login_after_reset = self.client.post(
            "api/v1/auth/login", data=new_login_data)
        self.assertEqual(login_after_reset.status_code, 202,
                         "Login was not successful after reset")
